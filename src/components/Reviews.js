  ...
  return (
    <div className='mt-4 border-t-2 border-gray-700 w-full'>
        ...
        <input 
            ...
            className='w-full p-2 outline-none header bg-gray-800 border-spacing-0 '
        />
        <button  onClick={sendReview} className=' mt-4 bg-green-600 flex justify-center w-full p-2'>
